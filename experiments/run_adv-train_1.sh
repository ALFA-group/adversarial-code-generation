...
./experiments/adv_train_seq2seq.sh 1 2 3 true 1 0.4 true 3 false false false v2-4-z1-pgd3 $TRANSFORM_NAME 0.5 0.5 1.0 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0

./experiments/adv_train_seq2seq.sh 1 2 3 true 1 0.4 true 3 false false true v2-5-z1-pgd3-smooth $TRANSFORM_NAME 0.5 0.5 1.0 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0
