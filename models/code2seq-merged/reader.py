...
class Reader:
    ...
    def __init__(self, subtoken_to_index, target_to_index, node_to_index, config, is_evaluating=False, adv_training = False, adv_transf = 0, adv_testing = False, indexed=False):
        ...
        # if indexed and adv_training:
            # raise Exception('indexed (used only for gradient attack) and adv training cannot be true together')
        ...
        print('Reader with:', self.file_path)
